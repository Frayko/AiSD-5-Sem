...
private:
	...
	public:
		...
		explicit Node(Key key, Data data = Data(), int countSubNode = 1, Node* left = nullptr, Node* right = nullptr) : key(key), data(data), countSubNode(countSubNode), left(left), right(right) {}
	};
